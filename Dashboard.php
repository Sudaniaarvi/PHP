    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="https://sites.google.com/view/sudaniaarvi" target="_blank">Google Site</a></li>
                    <li class="list-group-item"><a href="https://www.linkedin.com" target="_blank">LinkedIn</a></li>
                    <li class="list-group-item"><a href="https://www.youtube.com/watch?v=OFv5SxkD3I0" target="_blank">Blog</a></li>
                    <li class="list-group-item"><a href="https://github.com/Sudaniaarvi/PHP" target="_blank">GitHub</a></li>
                </ul>
            </nav>
            <!-- Main content -->
            <main class="col-md-9">
                ...
                <div class="container">
                    ...
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
                            <button class="ocean-blue-button gradient-button"><a href="https://github.com/Sudaniaarvi/PHP/tree/main/Task_1">Task 1</a></button>
<button class="sunset-orange-button gradient-button"><a href="https://github.com/Sudaniaarvi/PHP/tree/main/Task_2">Task 2</a></button>
<button class="spring-green-button gradient-button"><a href="https://github.com/Sudaniaarvi/PHP/tree/main/Task_3">Task 3</a></button>
